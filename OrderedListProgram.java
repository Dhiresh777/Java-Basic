/*
  file name:OrderedListProgram.java
		...
		public static void main(String args[])
			{
				...
				{	
					...
					FileReader fr=new FileReader("/home/bridgeit/Documents/Dhiresh/programs/Ordered.txt");//Path of the file to read					
					...
					fr.close();
					FileWriter fw = new FileWriter("/home/bridgeit/Documents/Dhiresh/programs/Ordered.txt");//Path of the file to write					
