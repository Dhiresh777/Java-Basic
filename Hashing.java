/*
  ...
  Purpose:26. Hashing Function to search a Number in a slot
*/
package com;
...
public class Hashing
{
	public static void main(String args[])
	{
		...
		{	
			...
			FileReader fr=new FileReader("/home/bridgeit/Documents/Dhiresh/programs/hashing.txt");//Path of the file to 	read					
